...
class GradeService {
   ...
   * For large datasets (>10k grades), consider MongoDB aggregation pipeline.
   * @param {Object} filters - Optional filters (class, trimester)
   * @returns {Promise<Array>} Array of subjects with nested student grades
   */
  async getGradesGroupedBySubject(filters = {}) {
    ...
    // Fetch grades with populated references
